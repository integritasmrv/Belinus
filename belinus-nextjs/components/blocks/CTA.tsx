  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto text-center bl-cta__content">
        ...
        <h2 className="text-[clamp(32px,5vw,56px)] font-black leading-[1.1] tracking-[-0.02em] text-white mb-5">
          {t('headline')}
        </h2>
        <p className="text-[17px] text-white/50 mb-10">
          {t('subhead')}
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-12 pt-12 border-t border-white/[0.08]">
          <div>
            <div className="text-[13px] font-semibold tracking-[0.15em] uppercase text-white/30 mb-3">
              {t('phone_label')}
            </div>
